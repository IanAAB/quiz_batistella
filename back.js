...
botao.addEventListener('click', enviar) // 2 2 3 2 2 2 4 3 3 4 3 2 4 2 3 3 2 4
function enviar(){
    if (q1.value == "opção 2") {
        pontos++
    }
    ...
    if (q10.value == "opção 4") {
        pontos++
    }
    if (q11.value == "opção 3") {
        pontos++
    }
    if (q12.value == "opção 2") {
        pontos++
    }
    if (q13.value == "opção 4") {
        pontos++
    }
    ...
    if (q16.value == "opção 3") {
        pontos++
    }
    if (q17.value == "opção 2") {
        pontos++
    }
    if (q18.value == "opção 4") {
        pontos++
    }
    pontuacao.textContent =String(fname + ',' + ' você acertou ' + pontos + ' especialidades.');
